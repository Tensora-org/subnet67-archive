...
contract TenexiumStorage {
    ...
    mapping(address => mapping(uint256 => uint256)) public lastLiquidationBlock; // Last block when liquidatePosition was called for a position
    mapping(address => mapping(uint256 => uint256)) public firstLiquidatableBlock; // First block when position became liquidatable
